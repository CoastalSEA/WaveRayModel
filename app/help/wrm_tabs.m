...
% On the *Cases* tab, using the mouse to click on the ID of a case record generates a
...
% dataset, which may be a list of files for imported data, or details of the
% model used.
