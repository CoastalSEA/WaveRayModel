...
%--------------------------------------------------------------------------
        function menu = setMenus(obj)
            ...
            menu.Setup(9).Callback = repmat({@obj.datacleanup},[1,13]);
            menu.Setup(9).Separator = [repmat({'off'},[1,7]),...
            ...
            menu.Analysis(3).List = {'Case','Model','SPT File',...
                                      ...
                                      'Bimodal analysis','FitModel2Measured',...
                                      'Estimate JONSWAP gamma','cfModel&&Measured',...
                                      'Subsample timeseries',...
                                      'O/I Spectrum','O/I Animation'};
            menu.Analysis(3).Callback = [repmat({@(src,evt) ctWaveSpectraPlots.runPlotOption(src,evt,obj)},[1,11]),...
